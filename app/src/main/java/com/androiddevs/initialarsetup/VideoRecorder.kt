...
class VideoRecorder(
    ...
    private fun setupMediaRecorder(){
        ...
        mediaRecoder?.apply {
            ...
            if(Build.VERSION.SDK_INT <= Build.VERSION_CODES.P){
                setOutputFile(buildFle()?.absolutePath)
            }else{
    ...
    private fun buildFileApi29(): FileDescriptor?{
        ...
        return activity.contentResolver.openFileDescriptor(uri ?: return null, "w")?.fileDescriptor // w means write
    }
    ...
    private fun startRecording(){
        ...
        encoderSurface = mediaRecoder?.surface
